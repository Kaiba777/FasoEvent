...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      @if (!request()->routeIs('public.inscription-option') && !request()->routeIs('public.inscription-promoteur') && !request()->routeIs('public.inscription-abonne') && !request()->routeIs('public.connexion'))
